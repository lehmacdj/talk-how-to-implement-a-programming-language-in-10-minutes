...
\begin{frame}{Background}
  \begin{itemize}
    ...
    \item There are things that just aren't possible without writing a new
      language
  \end{itemize}
\end{frame}
...
\begin{frame}{Basics}
  \begin{itemize}
    ...
    \item<2-> An expression like $1 + 2 * (1 + 2)$ would be represented as this AST:\\
      \Tree [.{+} 1 [.{*} 2 [.{+} 1 2 ] ] ]
...
\begin{frame}{Printing + Basic Commands}
\end{frame}
